...
const ContactTable = () => {
  return (
    <div  className=' bg-blue-100 wave '>
            ...
            <table className=' w-full'>
                ...
                <tbody className=' z-10'>
                    ...
                    <tr className=' border-b-2 border-b-white hover:backdrop:blur-sm duration-100'>
                        ...
                        <td className=' invisible text-gray-600 relative bottom-2 border-3 border-black text-left px-10 py-4 flex flex-row items-center text-xl gap-3'>
                            <span>
                    ...
                    <tr className=' border-b-2 border-b-white hover:backdrop:blur-sm duration-100'>
                        ...
                        <td className=' text-gray-600 relative bottom-2 border-3 border-black text-left px-10 py-4 flex flex-row items-center text-xl gap-3'>
                            <span>
                            <AiOutlineStar className=''></AiOutlineStar>
                            </span>
                            <span>
